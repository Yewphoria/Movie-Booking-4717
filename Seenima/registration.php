...
<body>
    ...
    <div id="content">
				...
				<form action="register.php" method="POST" id="reg_form" onsubmit="return registerSubmit()">
					<br>
					<table style="color:white;" id="login_content_table">
                        ...
                        <a href="login.php" style="color:#ffffff; margin-left:10px"> Already registered? Login here instead!</a>
<br>
						<br>
					</table>
				</form>
